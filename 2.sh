...
# 1. Настройка физического интерфейса (ens33)
echo "1. Настройка физического интерфейса ens33:"
...
sudo nmcli con modify static-ens33 ipv4.addresses 10.100.0.2/24
sudo nmcli con modify static-ens33 ipv4.gateway 10.100.0.1
sudo nmcli con modify static-ens33 ipv4.dns 8.8.8.8
# ipv4.method — метод получения IP. manual — статическая настройка (не DHCP)
sudo nmcli con modify static-ens33 ipv4.method manual
...
ping -c 4 -I ens33 10.100.0.3 # реальный интерфейс
